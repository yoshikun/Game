package builder
{
	...
	public class InfoBuilder extends BuilderBase
	{
	    public function InfoBuilder(cmds:Array, objMap:Object)
	    {
	        super(cmds, objMap);
	    }
	    ...
	    {
	        var url:String = PathManager.appPath + PathManager.protocolOutputPath + "/vo/";
	        for each (var obj:Obj in _objMap)
	        {
