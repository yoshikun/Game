package com.yo.utils
{
    public class MathUtil
    {
		 ...
		 */		
		public function hermite(t:Number, p0:Vector2D, m0:Vector2D, p1:Vector2D, m1:Vector2D):Vector2D {
			var t2:Number = t * t;
			var t3:Number = t2 * t;
		 ...
		 * 
		 */		
		public function catmullRom(t:Number, p0:Vector2D, p1:Vector2D, p2:Vector2D, p3:Vector2D):Vector2D {
			// 计算出所有切线
			// 一般切线取值为0.2
			var m1:Vector2D = tangent(p0, p2);
			var m2:Vector2D = tangent(p1, p3);
		 ...
		 */		
		public function catmullRom2(t:Number, p0:Vector2D, p1:Vector2D, p2:Vector2D, p3:Vector2D):Vector2D {
			var t2:Number = t * t;
			var t3:Number = t2 * t;
			var v:Vector2D = new Vector2D();
			v.x = 0.5 * (2 * p1.x +
		 ...
		 * 
		 */		
		public function quadBezier(t:Number, p0:Vector2D, p1:Vector2D, p2:Vector2D):Vector2D {
			var v:Vector2D = new Vector2D();
			var t2:Number = t * t;
		...
		public function tangent(p1:Vector2D, p2:Vector2D):Vector2D {
			return p2.subtract(p1).multiply(0.5);
		}
    }
}