                ...
                if (formater == STRING_FORMATTER){
                    ...
                    switch (formater){
                        ...
                        case DATE_TOLOCALE_FORMATTER:
                            var t:Date = replacementValue as Date;
                            match.replacement = t.toLocaleString();
                            break;
                        ...
                        case DATE_SECONDS_FORMATTER:
                            ...
                            break;    
                        case DATE_MICRO_SECONDS_FORMATTER:
                            match.replacement = replacementValue["milliseconds"];
                            break;    
                    }
                }else{
                    //no good replacement
...
const DATE_MICRO_SECONDS_FORMATTER : String = "j";
...
function padString(str:String, paddingNum:int, paddingChar:String=" ") : String
{
	...
	var p:String = new Array(paddingNum).join(paddingChar).substr(0,paddingNum-str.length);
    return p.concat(str);
}