...
package net.response.mail
{
     ...
     * 返回邮件内容(18:6)
     */
    public class ReqOpenMailResponse implements IResponse
    {
        /**
         * 唯一id
         */
         ...
         * 附件道具
         */
        public var itemList:Array /* of ItemInfo */;
        ...
        public function read(p:Packet):void
        {
            ...
            accessory = p.readUnsignedByte();
            text = p.readMultiByte(256, "utf-8");
            recvMoney = p.readUnsignedInt();
            recvGold = p.readUnsignedInt();
